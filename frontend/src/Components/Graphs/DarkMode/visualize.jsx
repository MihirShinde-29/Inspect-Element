        ...
        <Grid container style={{padding:'3%'}}>
            ...
            <Grid item md={12} lg={4}>
                ...
                <Grid container style={{borderLeft:'1px solid grey',padding:'4px'}}>
                    <Grid item md={12} style={{padding:'2%',margin:'2.2%'}}>
                        <p style={{ color: 'orangered' }}>Low Stock
                            <span style={{ float: "right", color: 'orangered',padding:'1.2%' }}>13</span></p>
                        <p>Item Groups
                            <span style={{ float: "right",padding:'1.2%' }}>23</span></p>
                        <p>All Items
